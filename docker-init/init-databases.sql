-- =====================================================
-- SMART HEALTHCARE APPLICATION - DATABASE INITIALIZATION
...
--
-- -- =====================================================
-- -- VERIFICATION QUERIES (can be run to verify data)
-- -- =====================================================
-- -- SELECT 'Users' as Table, COUNT(*) as Count FROM usersdb.users;
-- -- SELECT 'Hospitals' as Table, COUNT(*) as Count FROM hospitalsdb.hospitals;
-- -- SELECT 'Departments' as Table, COUNT(*) as Count FROM hospitalsdb.departments;
-- -- SELECT 'Doctors' as Table, COUNT(*) as Count FROM doctorsdb.doctors;
-- -- SELECT 'Time Slots' as Table, COUNT(*) as Count FROM doctorsdb.time_slots;
-- -- SELECT 'Patients' as Table, COUNT(*) as Count FROM patientsdb.patients;
-- -- SELECT 'Appointments' as Table, COUNT(*) as Count FROM appointmentsdb.appointments;
-- -- SELECT 'Medical Visits' as Table, COUNT(*) as Count FROM ehrdb.medical_visits;
-- SELECT 'Prescriptions' as Table, COUNT(*) as Count FROM ehrdb.prescriptions;