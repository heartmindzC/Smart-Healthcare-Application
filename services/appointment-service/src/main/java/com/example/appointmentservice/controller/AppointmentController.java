...
public class AppointmentController {
    ...
    // Lấy appointments theo doctor và ngày cụ thể
    // @GetMapping("/doctor/{doctorId}/date")
    // public ApiResponse<List<Appointment>> getAppointmentsByDoctorAndDate(
    // @PathVariable String doctorId,
    ...
    // appointmentService.findByDoctorAndDateRange(doctorId, start, end);
    // return ApiResponse.<List<Appointment>>builder()
    // .result(appointments)
    // .build();
    // }
    ...
    public ApiResponse<Appointment> cancelAppointment(@PathVariable String appointmentId) {
        // Các logic (ktra timeslotid, gọi service khác) được chuyển vào Cancel
        // appointment
     ...
     * POST
     * /appointments/send-confirmation-email/{appointmentId}?email=abc@gmail.com
     */
    ...
    // // response.setStatus(false);
    // // response.setMessage("Appointment must be CONFIRMED before sending
    // confirmation email");
    ...
    // hospitalAddress =
    // hospitalServiceClient.getHospitalAddress(appointment.getHospitalId())
    // .orElse(null);
    // }
    //
